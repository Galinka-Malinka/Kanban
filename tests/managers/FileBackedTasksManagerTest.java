...
class FileBackedTasksManagerTest extends TaskManagerTest {
    ...
    FileBackedTasksManager manager = file.exists() ? loadFromFile(file) : new FileBackedTasksManager("test.txt");
    ...
    void shouldSave() {  //  Проверка сохранения и загрузки файла
        ...
        manager.save();
        FileBackedTasksManager managerLoad = loadFromFile(manager.getFile());
        ...
        manager.clearTask();
        manager.save();
        FileBackedTasksManager managerLoadEmptyFile = loadFromFile(manager.getFile());
